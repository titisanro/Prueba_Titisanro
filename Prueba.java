...
class Prueba {
    static class Player {
        ...
        Player(String name, String position, int price) {
            this.name = name;
        ...
        public String toString() {
            return name + " - " + position + " - Precio: " + price;
        }
    }
    ...
    static class FantasyGameController {
        ...
        void displayAvailablePlayersByPosition(String position) {
            ...
            for (Player player : availablePlayers) {
                if (player.position.equals(position) && player.price <= fantasyTeam.budget) {
                    System.out.println(player);
                }
            }
        }
        ...
        while (true) {
            ...
            if (selectedPlayer != null && selectedPlayer.price <= fantasyTeam.budget) {
                ...
                System.out.println(selectedPlayer.name + " ha sido añadido al equipo.");
                System.out.println("");
            } else {
        ...
        while (true) {
            ...
            if (selectedPlayer != null && fantasyTeam.players.contains(selectedPlayer)) {
                String removedPosition = selectedPlayer.position;
                fantasyTeam.removePlayer(selectedPlayer);
                System.out.println(selectedPlayer.name + " ha sido quitado del equipo.");
                System.out.println("");
                ...
                while (true) {
                    ...
                    if (newSelectedPlayer != null && newSelectedPlayer.position.equals(removedPosition)
                            && newSelectedPlayer.price <= fantasyTeam.budget) {
                        fantasyTeam.addPlayer(newSelectedPlayer);
                        System.out.println(newSelectedPlayer.name + " ha sido añadido al equipo.");
                        System.out.println("");
                        break;
                    } else {
                        System.out.println("Selección no válida o excede el presupuesto. Intenta de nuevo.");
